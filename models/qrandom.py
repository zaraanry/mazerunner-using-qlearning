...
class AbstractModel(ABC):
    def __init__(self, maze, **kwargs):
        self.environment = mazefrom abc import ABC, abstractmethod
...
class RandomModel(AbstractModel):
    ...
    def predict(self, **kwargs):
        ...
        """
        return random.choice(self.environment.actions)from abc import ABC, abstractmethod
...
class RandomModel(AbstractModel):
    ...
    def predict(self, **kwargs):
        """ Randomly choose the next action.
            ...
            :return int: Chosen action.
        """
        return random.choice(self.environment.actions)import logging
import random
