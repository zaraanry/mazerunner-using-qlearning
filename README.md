...
1. *RandomModel* is the simplest model and just selects the next move randomly. It is dumb all over and learns nothing. Your are lucky if you get to the exit using this model.
...
![Maze](https://github.com/zaraanry/mazerunner-using-qlearning/blob/master/maze.png)
